...
user_pref("zen.tab-unloader.enabled", false); // use Auto Discard addon instead
...
user_pref("zen.view.experimental-no-window-controls", true); // remove animation when I hover over top edge of window
...
user_pref("zen.urlbar.replace-newtab", false); // remove animation when I hover over top edge of window
user_pref("zen.view.show-newtab-button-top", false); // remove animation when I hover over top edge of window
